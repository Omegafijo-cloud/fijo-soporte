...
export default function OmegaPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen text-foreground">
            <AnimatedBackground />
            <header className="relative z-50 flex items-center justify-between h-16 px-6 bg-card/80 backdrop-blur-sm border-b">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 bg-muted/80 backdrop-blur-sm px-3 py-1 rounded-lg">
                        <Timer className="h-6 w-6 text-primary" />
                        <span className="font-mono text-lg font-semibold">{formatTime(time)}</span>
                    </div>
                    <div className='flex items-center gap-1'>
                        <Input type="number" value={duration} onChange={handleDurationChange} className="w-20 h-9 text-center bg-card/80 backdrop-blur-sm" min="1" placeholder="Mins" />
            ...
            <main className="flex flex-col flex-1 w-full pt-16">
                <nav className="sticky top-0 z-40 flex justify-center w-full h-14 bg-card/80 backdrop-blur-sm border-b">
                ...
                <div className="flex-1 p-4 sm:p-6 lg:p-8">
                    <Card className="bg-card/80 backdrop-blur-sm"><CardContent className="p-0">{renderTabContent()}</CardContent></Card>
                </div>
            </main>
